...
export default function Staff2WorkReportPage() {
  ...
  const fetchReports = async () => {
    try {
      ...
      const response = await fetch(`${API_BASE}/api/staff/2/reports?${queryParams}`, {
  ...
  const handleSubmitReport = async () => {
    try {
      ...
      const response = await fetch(`${API_BASE}/api/staff/2/reports`, {
        method: 'POST',
        headers: headers,
          ...
          <div className="p-6">
            ...
            <div className="mb-6">
              ...
              <input
                ...
                className="w-full md:w-48 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
                placeholder="0"
                min="0"
              />
            </div>
