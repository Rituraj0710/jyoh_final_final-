...
export default function Staff4LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        console.log('Staff4 login successful, user role:', userRole);
        ...
        } else if (['staff5'].includes(userRole)) {
          router.push('/staff1/dashboard'); // Other staff roles go to staff1 dashboard for now
        } else {
          setError('Access denied. Staff4 access required.');
        }
      } else {
      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          <div className="mx-auto h-12 w-12 bg-purple-600 rounded-lg flex items-center justify-center">
            <span className="text-white text-xl font-bold">S4</span>
          </div>
