...
export default function Staff5LockedFormsPage() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading locked forms...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-gray-900">Locked Forms</h1>
          <p className="text-gray-600">Forms that have been locked by Staff5 final authority</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow">
          <div className="px-6 py-4 border-b border-gray-200">
            <h2 className="text-lg font-medium text-gray-900">Locked Forms ({pagination.total || 0})</h2>
          </div>
          ...
          {forms.length === 0 ? (
            <div className="px-6 py-12 text-center">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">No locked forms found</h3>
              <p className="text-gray-500">No forms have been locked yet.</p>
            </div>
          ) : (
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      ...
                      <div className="mt-2 text-sm text-gray-500">
                        ...
                        <p>Locked: {form.approvals?.staff5?.lockedAt ? new Date(form.approvals.staff5.lockedAt).toLocaleString() : 'Unknown'}</p>
                      </div>
                      ...
                      {/* Final Remarks */}
                      {form.approvals?.staff5?.finalRemarks && (
                        <div className="mt-3 p-3 bg-gray-50 rounded-lg">
                          <p className="text-sm font-medium text-gray-700">Final Remarks:</p>
                          <p className="text-sm text-gray-600">{form.approvals.staff5.finalRemarks}</p>
                        </div>
                      )}
                      ...
                      <div className="mt-3 p-3 bg-red-50 rounded-lg">
                        <div className="flex items-center">
                          ...
                          <span className="text-sm font-medium text-red-800">Form is locked</span>
                        </div>
                        <p className="text-xs text-red-600 mt-1">No further changes allowed</p>
                      </div>
                    </div>
