...
export default function Staff5PendingFormsPage() {
  ...
  const getVerificationStageBadge = (form) => {
    ...
    if (staff1Complete && staff2Complete && staff3Complete && staff4Complete) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-gray-900">Pending Final Approval</h1>
          <p className="text-gray-600">Forms ready for Staff5 final review and approval</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow">
          ...
          {forms.length === 0 ? (
            <div className="px-6 py-12 text-center">
              ...
              <p className="text-gray-500">No forms are currently pending final approval.</p>
            </div>
          ) : (
