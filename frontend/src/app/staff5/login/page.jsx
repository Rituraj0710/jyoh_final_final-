...
export default function Staff5LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        console.log('Staff5 login successful, user role:', userRole);
        ...
        if (userRole === 'admin') {
          ...
          setError('Access denied. Staff5 access required.');
        }
      } else {
      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          <div className="mx-auto h-12 w-12 bg-red-600 rounded-lg flex items-center justify-center">
            <span className="text-white text-xl font-bold">S5</span>
          </div>
