...
const AgentSidebar = () =>{
  ...
  return (
    <div className="bg-purple-800 text-white h-screen p-4">
      ...
      <nav>
        <ul>
          <li className="mb-4"><Link href="/agent/agent-profile" className="hover:text-indigo-400 transition duration-300 ease-in-out">Profile</Link></li>
          <li className="mb-4"><Link href="/agent/agent-change-password" className="hover:text-indigo-400 transition duration-300 ease-in-out">Change Password</Link></li>
